...
Lyric _$LyricFromJson(Map<String, dynamic> json) => Lyric()
  ...
  ..transUser = json['transUser'] as Map<String, dynamic>?
  ..lyricUser = json['lyricUser'] as Map<String, dynamic>?
  ..lrc = json['lrc'] as Map<String, dynamic>?
  ..klyric = json['klyric'] as Map<String, dynamic>?
  ..tlyric = json['tlyric'] as Map<String, dynamic>?
  ..romalrc = json['romalrc'] as Map<String, dynamic>?

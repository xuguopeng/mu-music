...
def scan_default_assets(conn: Connection) -> list[dict]:
    ...
    assets = [
        ...
        ("请回答1992漫画工作流", "document", "comic", "Documents/徐徐如声/徐徐如声/产品库/漫画生成工具/projects/请回答1992/index.md", "请回答1992 IP 与漫画工作流索引。"),
        ("第一次战斗漫画项目", "comic_project", "comic", "Documents/徐徐如声/徐徐如声/产品库/漫画生成工具/projects/请回答1992/stories/第一次战斗", "已有漫画作品和公众号草稿。"),
        ...
        ("TauriVideo", "project", "video", "Documents/徐徐如声/徐徐如声/产品库/AI视频生成/code/徐-AI视频生成/TauriVideo", "AI 视频生成和画布项目参考。"),
        ("Plotforge 小说桌面端", "project", "novel", "Documents/徐徐如声/徐徐如声/产品库/AI爆款小说生成器/code/徐-写小说/desktop", "小说创作桌面项目参考。"),
        ("wxwrite 公众号写作", "project", "blog", "Documents/徐徐如声/徐徐如声/产品库/公众号工具/code/徐-公众号爆文生成/wxwrite", "公众号写作项目参考。"),
